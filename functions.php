...
if ( ! function_exists( 'synapse_theme_setup' ) ) :
  // то создадим ф-цию добавления 
    function synapse_theme_setup() {

			// Удаляем роль при деактивации нашей темы
			add_action( 'switch_theme', 'deactivate_synapse_theme' );
			function deactivate_synapse_theme() {
				remove_role( 'developer' );
			}

			// Добавляем роль при активации нашей темы
			add_action( 'after_switch_theme', 'activate_synapse_theme' );
			function activate_synapse_theme() {
...
function enqueue_synapse_style() {
  ...
  wp_enqueue_style( 'swiper-slider', get_template_directory_uri( ).'/assets/css/swiper-bundle.min.css','style',time());
	wp_enqueue_style( 'synapse_theme-style', get_template_directory_uri( ).'/assets/css/synapse_theme.css','style',time());
  wp_enqueue_style('Roboto-Slab','https://fonts.googleapis.com/css2?family=Roboto+Slab:wght@700&display=swap');
	wp_enqueue_style( 'Playfair-Display', 'https://fonts.googleapis.com/css2?family=Playfair+Display&display=swap%27');
  wp_enqueue_style( 'Roboto', 'https://fonts.googleapis.com/css2?family=Roboto:wght@300;400;500;700;900&display=swap%27');
...
add_action( 'wp_enqueue_scripts', 'enqueue_synapse_style' );
...
} // end of the_breadcrumbs() //Хлебные крошки